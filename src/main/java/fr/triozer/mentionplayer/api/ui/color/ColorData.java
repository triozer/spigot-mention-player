...
public class ColorData {
    ...
    public final static ColorData CYAN         = new ColorData("Cyan", ChatColor.AQUA, DyeColor.LIGHT_BLUE);
    public final static ColorData DARK_AQUA    = new ColorData("Dark Aqua", ChatColor.DARK_AQUA, DyeColor.CYAN);
    ...
    public final static ColorData DARK_PURPLE  = new ColorData("Dark Purple", ChatColor.DARK_PURPLE, DyeColor.PURPLE);
    ...
    public ColorData(String name, String permission, ChatColor[] chatColor, DyeColor[] dyeColor, boolean custom) {
        ...
        getInstance().getColorData().put(this.id, this);
    }
    ...
    private ColorData(String name, ChatColor chatColor, DyeColor dyeColor) {
        this(name, getInstance().getConfig().getString("options.permission.color." + name.replace(" ", "-").toLowerCase()), new ChatColor[]{chatColor}, new DyeColor[]{dyeColor}, false);
    }
